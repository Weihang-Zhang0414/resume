            ...
            server.middlewares.use(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    if (req.url === '/api/portfolio' && req.method === 'GET') {
                        ...
                        req.on('end', function () {
                            try {
                                var dataPath = path.resolve('public/data/portfolio.json');
                                // Format JSON nicely with 2 spaces
                                fs.writeFileSync(dataPath, JSON.stringify(JSON.parse(body_1), null, 2), 'utf-8');
                                res.setHeader('Content-Type', 'application/json');
